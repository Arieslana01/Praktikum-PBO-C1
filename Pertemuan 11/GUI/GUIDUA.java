 ...
 * @author apple
 */
public class GUIDUA extends javax.swing.JFrame {
    DefaultListModel<String> dlm;
    /**
     * Creates new form GUIDUA
     */
    public GUIDUA() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIDUA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
